...
<html lang="en">
  ...
  <head>
    ...
    <link href="{{asset('admin-style/css/sb-admin.css')}}" rel="stylesheet">
  ...
  <body id="page-top">
    ...
    <!-- Sidebar -->
      <ul class="sidebar navbar-nav">
          ...
          <li class="nav-item dropdown">
              ...
              <div class="dropdown-menu" aria-labelledby="pagesDropdown">
                  <a class="dropdown-item" href="/admin/dynamics/home">Home Page</a>
                  <a class="dropdown-item" href="/admin/dynamics/about">About page</a>
                  <a class="dropdown-item" href="/admin/dynamics/price">Price page</a>
              </div>
          </li>
          <li class="nav-item dropdown">
    ...
    <script src="{{asset('admin-style/js/sb-admin.min.js')}}"></script>
